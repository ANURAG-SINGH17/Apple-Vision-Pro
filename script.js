...
gsap.to('#image-bottom h1',{
  scrollTrigger:{
    trigger:'#image-bottom h1',
    start:'top 5%',
    end:'bottom top',
    scroller:'#main',
  },
...
gsap.to('#image-bottom svg',{
  scrollTrigger:{
    trigger:'#image-bottom svg',
    start:'top 5%',
    end:'bottom top',
    scroller:'#main',
  },
...
let videoPlayed = false; // Flag to ensure the video plays only once

gsap.to('#page4-center>video', {
    scrollTrigger: {
        trigger: '#page4-center>video',
        start: 'top 60%',
        end: 'bottom top',
        scroller: '#main',
        onEnter: () => {
            if (!videoPlayed) {
                document.querySelector('#page4-center>video').play();
                videoPlayed = true; // Set the flag to true after the video plays
            }
        }
    }
});
